...
### Relation between Loan Amount and MPI
...
A Mean Absolute Error (MAE) of approximately 461.96 suggests that on average, the predictions of our model deviate from the actual values by about 461.96.
...
The target variable `loan_amount` ranges between 25 and 50000 where the median is 500, an MAE of 461.96 suggest that the model is not performing well and there is scope for improvement
